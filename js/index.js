...
function websdkready() {
	...
	var CLIENT_ID = "UXT5zf6R1WPp4bfKNsSeg";
	/**
   ...
   */
	var CLIENT_SECRET = "yZQHLsbUhhZXJ6F7ox1pPfsmtGWVBCN8"

	// some help code, remember mn, pwd, lang to cookie, and autofill.
	document.getElementById("display_name").value = "CDN" + ZoomMtg.getWebSDKVersion()[0] + testTool.detectOS() + "#" + testTool.getBrowserInfo();
